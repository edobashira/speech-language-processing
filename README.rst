...
- `NLP Compromise <https://github.com/spencermountain/nlp_compromise>`_ a Natural-Language-Processing library in Javascript, small-enough for the browser, and quick-enough to run on keypress
